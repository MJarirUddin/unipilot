...
contract IndexFund {
    ...
    address private constant PILOT_ADDRESS = 0x2e53716051bE4BCCE9F546fcfb0ef7632E505DBD; //unit test addr
    ...
    function migrateFunds(address payable _newVersion, address[] calldata tokens)
        external
        onlyTimelock
    {
