...
contract UniswapLiquidityManager is PeripheryPayments, IUniswapLiquidityManager {
    ...
    function initialize(address unipilot) public {
        _unipilot = unipilot;
    }
    ...
    function _isGovernance() private view {
        require(msg.sender == IUnipilot(unipilotProtocolDetails.indexFund).governance());
    }
    ...
    function _mintPilot(address recipient, uint256 amount) private {
        IUnipilot(unipilotProtocolDetails.indexFund).mintPilot(recipient, amount);
    }
