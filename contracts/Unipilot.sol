...
contract Unipilot is IUnipilot, ERC721Permit, PeripheryPayments {
    ...
    constructor(address _governance, address _initialExchangeManager)
        // address _mintProxy
    ...
    /// @param data data[0] required data for deposi0xe78A0F7E598Cc8b0Bb87894B0F60dD2a88d6a8Abt & data[1] required data for pool creation on respective dex
